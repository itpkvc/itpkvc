...
//get find theme
$('#themeImageModal').on('hidden.bs.modal', function () {
    Swal.fire({
    title: 'รอสักครู่!',
...
checkImage=()=>{
    ...
    if(image !== ''){
        ...
        text: "คุณได้เลือกรูปไว้กรุณากดตกลงก่อนเสร็จสิ้นหรือก็รีเซ็ตก่อนเสร็จสิ้น!",
        icon: 'question',
 ...
 saveImage=(theme_id)=>{
    ...
    $.ajax({
        ...
        url: '/insertThemeImage?id='+theme_id,
        data: formdata,
        processData: false,
        contentType: false,
        cache: false,
